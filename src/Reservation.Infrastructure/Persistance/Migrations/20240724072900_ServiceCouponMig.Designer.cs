...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240724072900_ServiceCouponMig")]
    partial class ServiceCouponMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a47a40a-5534-40c1-96d9-763a90a2a7ce"),
                            CreatedOn = new DateTime(2024, 7, 24, 10, 58, 59, 870, DateTimeKind.Local).AddTicks(3758),
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Admin.TransferFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7e7fd110-33b0-4c85-b644-421daf4a7259"),
                            CreatedOn = new DateTime(2024, 7, 24, 10, 58, 59, 870, DateTimeKind.Local).AddTicks(5995),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Percent = 1
