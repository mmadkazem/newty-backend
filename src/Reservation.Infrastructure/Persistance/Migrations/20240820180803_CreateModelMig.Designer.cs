...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240820180803_CreateModelMig")]
    partial class CreateModelMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4fd0d07-75b3-4d36-8117-614e88cf93fe"),
                            CreatedOn = new DateTime(2024, 8, 20, 21, 38, 2, 913, DateTimeKind.Local).AddTicks(2228),
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Admin.TransferFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 8, 20, 21, 38, 2, 913, DateTimeKind.Local).AddTicks(5497),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Percent = 1
