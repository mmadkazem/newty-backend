...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240808102919_ChangeMig")]
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("672d679b-f9a7-4c2d-b984-31e816f1c139"),
                            CreatedOn = new DateTime(2024, 8, 8, 13, 59, 17, 618, DateTimeKind.Local).AddTicks(7846),
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Admin.TransferFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("090cd1fa-6d2b-447e-b776-d078ddcc7f6d"),
                            CreatedOn = new DateTime(2024, 8, 8, 13, 59, 17, 618, DateTimeKind.Local).AddTicks(9774),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Percent = 1
