...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240810123126_ModifiedCityMig")]
    partial class ModifiedCityMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aa24f2c7-6275-448f-bf59-0a657846aa73"),
                            CreatedOn = new DateTime(2024, 8, 10, 16, 1, 25, 575, DateTimeKind.Local).AddTicks(4558),
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Admin.TransferFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bf81c581-bd8d-482c-9838-e1bb76f8ab0a"),
                            CreatedOn = new DateTime(2024, 8, 10, 16, 1, 25, 575, DateTimeKind.Local).AddTicks(6272),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Percent = 1
