...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240524091936_TokenMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.BusinessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.BusinessToken", b =>
                {
                    b.HasOne("Reservation.Domain.Entities.Businesses.Business", "Business")
                        .WithOne("Token")
                        .HasForeignKey("Reservation.Domain.Entities.Account.BusinessToken", "BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.UserToken", b =>
                {
                    b.HasOne("Reservation.Domain.Entities.Account.User", "User")
                        .WithOne("Token")
                        .HasForeignKey("Reservation.Domain.Entities.Account.UserToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
