...
namespace Reservation.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240717135045_TransferFeeMig")]
    partial class TransferFeeMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("686b488d-108f-4db3-9f62-d78aab89e8f8"),
                            CreatedOn = new DateTime(2024, 7, 17, 17, 20, 45, 224, DateTimeKind.Local).AddTicks(6901),
            ...
            modelBuilder.Entity("Reservation.Domain.Entities.Admin.TransferFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c4e77438-4a5c-493c-8a5f-6768f36e28e6"),
                            CreatedOn = new DateTime(2024, 7, 17, 17, 20, 45, 224, DateTimeKind.Local).AddTicks(8554),
                            DeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Percent = 1
