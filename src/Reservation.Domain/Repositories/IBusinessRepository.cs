...
public interface IBusinessRepository
{
    ...
    Task<IEnumerable<IResponse>> GetNormalUser(Guid businessId, int page, int size, CancellationToken cancellationToken);
    Task<IEnumerable<IResponse>> GetVIPUser(Guid businessId, int page, int size, CancellationToken cancellationToken);
