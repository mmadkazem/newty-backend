...
public interface ICategoryRepository
{
    ...
    Task<IEnumerable<IResponse>> GetBusiness(Guid categoryId, int page, CancellationToken cancellationToken);
    Task<IEnumerable<IResponse>> Search(string key, int page, CancellationToken cancellationToken);
}